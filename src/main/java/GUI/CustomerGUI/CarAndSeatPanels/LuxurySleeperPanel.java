...
public class LuxurySleeperPanel extends CarDetailsGUI {

	JPanel seatPanel = new JPanel();
	private int seatDistance;
	private int rowDistance;
	
	public LuxurySleeperPanel() {
		super(75, 50, MaxCarSeats.LuxurySleeperCar.NUMBER_OF_SEATS, 1);
	...
	public void setUpTopSeats() {
		final int NUM_OF_SEATS = super.getNumOfSeats() / 2;
		final int INDEX_OFFSET = MaxCarSeats.LuxurySleeperCar.NUMBER_OF_SEATS / 2;
		final int startingPosY = 17;
